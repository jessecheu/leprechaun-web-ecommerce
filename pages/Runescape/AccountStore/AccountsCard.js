...
export default ({id, identifier, title, gamemode, price, thumbnail, description, categories, accountlevel, postAt}) => {

    const [modalShow, setModalShow] = React.useState(false);

    return(
        <>
        <Card style={{ width: '22rem'}} bg={''} text={'dark'} border="warning">
